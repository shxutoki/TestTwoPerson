...
namespace Photon.Pun
{
    ...
    /// </remarks>
    [AddComponentMenu("Photon Networking/Photon Child Animator View")]
    public class PhotonChildAnimatorView : MonoBehaviourPun, IPunObservable
    {
        #region Enums
...
#pragma warning restore 0414
        ...
        private void Awake()
        {
            ...
            else
            {
                ...
                {
                    m_Animators.Add(this.transform.GetChild(i).gameObject.GetComponent<Animator>());
                }
            }
        }
        ...
        private void Update()
        {
            if (this.photonView.IsMine == false && PhotonNetwork.IsConnected == true)
            {
                ...
                {
                    if (this.m_Animator.applyRootMotion)
                    {
                        this.m_Animator.applyRootMotion = false;
                    }
                }

                if (this.m_Animators.Count != 0)
                {
